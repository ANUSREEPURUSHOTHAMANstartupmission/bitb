<script>
  ...
  <svelte:window bind:scrollY={y}/>
   ...
   flex sm:items-center
    ...
    z-50  py-2
           {scrolled ? 'bg-white top-0' : 'bg-transparent'}
    ...
    <div class="w-full container mx-auto  flex justify-between px-4">
     ...
     <main class=" flex  items-start px-7 my-auto">
        <div style="font-family: Museo-Sans, sans-serif;" class="flex my-auto  {scrolled?'text-black':'text-white'}">
            ...
            <a href="/leap-membership"  class="md:flex cursor-pointer hidden px-4 py-3  md:py-1 uppercase   text-sm">Objectives</a>
            
            <a href="/#leap_facility" class="md:flex hidden cursor-pointer  px-4 py-3  md:py-1 uppercase   text-sm">Impact</a>
        ...
        <div class="mb-8 gap-2  font-medium sm:bg-transparent p-5 sm:p-0 rounded-md flex items-center justify-center">
         ...
         <nav>
            <ul class=" md:text-sm gap-2 font-data">
                    ...
                    <li on:click="{()=> menu_open = !menu_open }" class="px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100 md:hidden flex">
                      <a href="/leap-co-works"  class="cursor-pointer text-white font-bold hover:text-black uppercase ">About</a>
                    </li>
                    <li on:click="{()=> menu_open = !menu_open }" class="px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100 md:hidden flex">
                      <a href="/leap-membership"  class="cursor-pointer text-white font-bold hover:text-black uppercase ">Objectives</a>
                    </li> 
                     <li on:click="{()=> menu_open = !menu_open }" class="px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100 md:hidden flex">
                      <a href="/#leap_facility"  class="cursor-pointer text-white font-bold hover:text-black uppercase ">Impact</a>
                    </li>
